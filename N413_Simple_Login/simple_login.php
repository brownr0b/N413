...
<html>
    <head>
		...
		function check_login(){
			if(log_in){
				$("#login").html('<a href="simple_logout.php">Logout</a>');
				$("#register").html('');
			}else{
    	...
    	<nav class="navbar navbar-inverse navbar-fixed-top">
          <div class="container">
            <div class="navbar-header"><!-- Mobile menu code -->
              ...
              <a class="navbar-brand" href="#">N413 Simple Login</a>
            </div> <!-- /.navbar-header -->
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-xs-12"> <!-- column for headline -->
				<h3 style="text-align:center;margin-bottom:2em;">N413 Simple Login</h3>
            </div> <!-- /col-xs-12 -->
          </div> <!-- /.row  -->
          <div class="row">
