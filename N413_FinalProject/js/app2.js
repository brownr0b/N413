    ...
    function weatherCity(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                var u = moment.tz((unix*1000), timezone);
                var rise = moment.tz((sunrise*1000), timezone);
                var set = moment.tz((sunset*1000), timezone);
                var date = moment.tz((unix*1000), timezone).format("dddd, MMMM Do YYYY, h:mm A zz");
