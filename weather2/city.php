    ...
    <div id="container">
        <nav>
            <div id="nav-left">
                ...
                <button id="geolocation"><i class="far fa-location-arrow"></i></button>
            </div>
            <div id="nav-right">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="history">
                        ...
                        <div id="historyContainer">
                            ...
                            if(mysqli_num_rows($result1) >= 1){
                                while($row1 = $result1->fetch_assoc()) {
                                    echo '<tr><td>'.$row1["city"].'</td><td>'.$row1["timestamp"].'</td><td><i class="far fa-times"></i></td></tr>';
                                }
                            }else{
                        ...
                        <span id="clearHistory-<?php echo $_SESSION["user_id"] ?>">Clear history</span>
                    </div>
                </div>
            </div>
        </div>
