    ...
    <div id="container">
        <nav>
            <div id="nav-left">
                ...
                <button id="geolocation" title="Find Me"><i class="far fa-location-arrow"></i></button>
            </div>
            <div id="nav-right">
                            ...
                            echo '<table id="historyTable"><thead><th>City</th><th>Date</th><th></th></thead>';
                                ...
                                if(mysqli_num_rows($result1) >= 1){
                                    while($row1 = $result1->fetch_assoc()) {
                                        echo '<tr><td>'.$row1["city"].'</td><td>'.$row1["timestamp"].'</td><td data-city="' .$row1["city"]. '"><i class="far fa-times"></i></td></tr>';
                                    }
                                }else{
